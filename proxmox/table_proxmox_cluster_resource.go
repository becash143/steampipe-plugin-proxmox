...
func tableProxmoxClusterResource() *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "vm_id", Type: proto.ColumnType_INT, Description: "VM/CT ID, if applicable.", Transform: transform.FromField("VMID")},
			...
			{Name: "max_cpu", Type: proto.ColumnType_INT, Description: "Max CPUs.", Transform: transform.FromField("MaxCPU")},
			{Name: "mem", Type: proto.ColumnType_INT, Description: "Current memory usage.", Transform: transform.FromField("Mem")},
			{Name: "max_mem", Type: proto.ColumnType_INT, Description: "Max memory.", Transform: transform.FromField("MaxMem")},
			{Name: "disk", Type: proto.ColumnType_INT, Description: "Current disk usage.", Transform: transform.FromField("Disk")},
			{Name: "max_disk", Type: proto.ColumnType_INT, Description: "Max disk.", Transform: transform.FromField("MaxDisk")},
