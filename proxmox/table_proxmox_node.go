...
func tableProxmoxNode() *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "max_cpu", Type: proto.ColumnType_INT, Description: "Number of CPUs.", Transform: transform.FromField("MaxCPU")},
			{Name: "mem", Type: proto.ColumnType_INT, Description: "Current memory usage.", Transform: transform.FromField("Memory")},
			{Name: "max_mem", Type: proto.ColumnType_INT, Description: "Maximum memory.", Transform: transform.FromField("MaxMemory")},
